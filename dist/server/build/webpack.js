...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(dir) {
    ...
    var config, defaultEntries, mainJS, _minChunks, entry, plugins, mainBabelOptions, hasBabelRc, rules, webpackConfig;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (dev) {
              plugins.push(new _webpack2.default.HotModuleReplacementPlugin(), new _webpack2.default.NoEmitOnErrorsPlugin(), new _unlinkFilePlugin2.default(), new _watchRemoveEventPlugin2.default(), new _watchPagesPlugin2.default(dir));
              if (!quiet) {
            ...
            webpackConfig = {
              ...
              resolve: {
                modules: [nextNodeModulesDir, 'node_modules'].concat((process.env.NODE_PATH || '').split(process.platform === 'win32' ? ';' : ':').filter(function (p) {
                  return !!p;
                }))
              },
              resolveLoader: {
                modules: [nextNodeModulesDir, 'node_modules', (0, _path.join)(__dirname, 'loaders')]
              },
              plugins: plugins,
              module: {
                rules: rules
